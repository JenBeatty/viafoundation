        ...
        ?>
            ...
            <div id="sub_heading">
                <ul>
                    ...
                    <li onclick="window.location = 'via-staff.php'"><div class="circle"><span class="text">3</span></div><a href="via-staff.php">Team</a><br /><span class="sub_text">Meet the people behind Via</span></li>
